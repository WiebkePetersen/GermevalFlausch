...
Important data:
  ...
  * sentiments_orig.pkl, sentiments_spelling_corrected.pkl, sentiments_translated.pkl -- sentiment polarity for original, spelling corrected & translated comments, in same order as in comments.csv
  * sentiments_anger/disgust/fear/joy/neutral/sadness/surprise.pkl -- sentiment scores for seven sentiments for translated comments, in same order as in comments.csv
  * features.csv -- values for all features (BERT, sentiments, counts)
  * features_results.csv -- combinations of features with log reg results
  ...
  * phrases_with_labels_inlcuding_not_flausch_train/test.csv -- spans for training classifier for spaCy spans
  * task2-predicted_spacy.csv -- prediction for test data with spaCy spans + classifier (from subtask2_spacy_with_classifier.ipynb)
  * task1-predicted.csv -- submission file for subtask 1 (from subtask1_test_prediction.ipynb)
